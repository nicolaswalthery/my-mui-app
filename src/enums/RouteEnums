// ========================================
// PRACTICAL ENUMS FOR YOUR MUI APPLICATION
// ========================================

// 1. Navigation/Route Enums
...
export namespace AppRoute {
  export function getDisplayName(route: AppRoute): string {
    switch (route) {
      case AppRoute.Dashboard: return 'Dashboard';
      case AppRoute.Home: return 'Home';
      case AppRoute.Auth: return 'Authentication';
      case AppRoute.Settings: return 'Settings';
      case AppRoute.Profile: return 'Profile';
      case AppRoute.Users: return 'Users';
      default: return 'Unknown';
    }
  }

  export function getIcon(route: AppRoute): string {
    switch (route) {
      case AppRoute.Dashboard: return 'Dashboard';
      case AppRoute.Home: return 'Home';
      case AppRoute.Auth: return 'Settings';
      case AppRoute.Settings: return 'Settings';
      case AppRoute.Profile: return 'Person';
      case AppRoute.Users: return 'People';
      default: return 'Help';
    }
  }
